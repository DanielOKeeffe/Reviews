...
public class ReviewRepository {
	...
	public ReviewRepository() {
		Review megaShark = new Review(1L, "Mega Shark vs. Giant Octopus", "C:\\Users\\decep\\eclipse-workspace\\reviews\\src\\main\\resources\\static\\images\\megashark.jpg", "Action", "Debbie Gibsons finest hour comes with a gritty, mesmerising performance in what has to be described as the film of the decade.\r\n" + 
				"\r\n" + 
		...
		Review sharknado = new Review(2L, "Sharknado", "C:\\Users\\decep\\eclipse-workspace\\reviews\\src\\main\\resources\\static\\images\\sharknado.jpg", "Action", "I only wish this movie had been released to Drive-In theaters and been promoted on a twin bill with any other low rent/grade/brow cinematic masterpiece from the ill human beings at SyFy.\r\n" + 
				"\r\n" + 
